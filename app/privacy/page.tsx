...
export const metadata: Metadata = {
  title: 'Privacy Policy | VindAircoMonteur.nl',
  description: 'Privacybeleid van VindAircoMonteur.nl. Lees hoe wij omgaan met uw gegevens.',
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            VindAircoMonteur.nl respecteert uw privacy en zet zich in voor de bescherming van uw persoonsgegevens.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Wij verzamelen geen persoonsidentificerende informatie tenzij u deze vrijwillig verstrekt
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            die op uw apparaat worden opgeslagen. U kunt cookies weigeren of verwijderen via uw browserinstellingen, maar
            dit kan de functionaliteit van de website beinvloeden.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Gegevens worden alleen gedeeld wanneer dit wettelijk verplicht is of noodzakelijk voor de
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">8. AVG Compliance</h2>
          <p className="mb-4">
            VindAircoMonteur.nl voldoet aan de Algemene Verordening Gegevensbescherming (AVG). Dit betekent
            dat wij transparant zijn over welke gegevens wij verzamelen, hoe wij deze gebruiken, en dat wij
            uw rechten als betrokkene respecteren.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            gecommuniceerd op onze website. Wij adviseren u deze pagina regelmatig te raadplegen.
          </p>
        </section>
      </div>
    </div>
