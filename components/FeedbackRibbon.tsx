  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const feedbackData: FeedbackData = {
        ...
        page_title: document.title || 'VindAircoMonteur.nl',
      };
  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed right-0 top-1/2 -translate-y-1/2 bg-cyan-600 text-white px-3 py-8 rounded-l-lg shadow-lg hover:bg-cyan-700 transition-all duration-300 z-40 ${
        ...
        <div className="w-80 max-h-[600px] p-6 overflow-y-auto">
          ...
          {isSubmitted ? (
            <div className="py-8 text-center">
              ...
              <p className="text-lg font-medium text-cyan-600">Bedankt!</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none text-sm"
                  rows={4}
