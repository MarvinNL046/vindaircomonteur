...
export const ContactConfirmationEmail = ({
  ...
  return (
    <BaseTemplate preview="Bedankt voor uw bericht - VindAircoMonteur.nl">
      <Heading style={heading}>Bedankt voor uw bericht!</Heading>

      <Text style={greeting}>Beste {name},</Text>

      <Text style={paragraph}>
        Wij hebben uw bericht ontvangen. Ons team bekijkt uw vraag en streeft ernaar
        binnen <strong>1-2 werkdagen</strong> te reageren.
      </Text>
      ...
      <Text style={paragraph}>
        ...
        over airco monteurs in Nederland.
      </Text>

      <Text style={signature}>
        Met vriendelijke groet,
        <br />
        <strong>Team VindAircoMonteur.nl</strong>
      </Text>
    </BaseTemplate>
  );
};
